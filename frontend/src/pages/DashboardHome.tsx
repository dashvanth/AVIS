...
const DashboardHome: React.FC = () => {
  ...
  const fetchDatasets = async () => {
    try {
      ...
      const uniqueDatasets = Array.from(latestDatasetsMap.values()).sort(
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h1 className="text-3xl font-bold text-avis-text-primary tracking-tight">
            Your Dashboard
          </h1>
          <p className="text-avis-text-secondary">
            Track your analysis results, insights, and visualizations.
          </p>
        </div>
        ...
        <div className="bg-avis-secondary border border-avis-border rounded-2xl p-6 min-h-[500px] shadow-sm relative overflow-hidden">
          ...
          <div className="flex justify-between items-center mb-6 relative z-10">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-avis-text-primary">
                History
              </h3>
            </div>
            <button
          ...
          {datasets.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 text-center animate-in fade-in zoom-in duration-500">
              ...
              <h4 className="text-lg font-semibold text-avis-text-primary mb-2">
                No History Yet
              </h4>
              <p className="text-avis-text-secondary max-w-sm mb-6">
                Upload your first dataset to start generating insights and
                visualizations.
              </p>
